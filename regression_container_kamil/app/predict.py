...
def process_3d_volume(volume_3d, target_spacing, current_spacing_3d, target_shape_3d, data_type):
    """
    ...
    resampled_volume = resample_image_3d(volume_3d, target_spacing, current_spacing_3d)
