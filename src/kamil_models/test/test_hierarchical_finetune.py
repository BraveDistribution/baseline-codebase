...
try:
    from finetune_hierarchical import HierarchicalConfig, create_hierarchical_model
    ...
    class MockArgs:
        ...
        split_idx = 0
        local_checkpoint = '/home/mg873uh/Projects_kb/checkpoints/contrastive_2gpu_1131/last2.ckpt'
